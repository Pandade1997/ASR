...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", required=True,
                        default="/data01/AuFast/origin_dataset/dataset/LibriSpeech/train-clean-100/*/*/*.wav")
    parser.add_argument(
        "--mode", choices=["character", "word", "subword"], required=True, default="word")
    parser.add_argument("--output_file", required=True,
                        default="/data01/AuFast/Pan_dataset/End-to-end-ASR/gen/train-clean-100")
